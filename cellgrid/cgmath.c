...
static char __pyx_k_Fancy_maths_functions[] = "Fancy maths functions";
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "cgmath",
    __pyx_k_Fancy_maths_functions, /* m_doc */
    -1, /* m_size */
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cgmath", __pyx_methods, __pyx_k_Fancy_maths_functions, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "cgmath")) {
      if (unlikely(PyDict_SetItemString(modules, "cgmath", __pyx_m) < 0)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
